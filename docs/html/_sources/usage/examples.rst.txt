...
`Example 6 <./examples/example_6.html>`_  validates a household generative agent against the US Census Household Pulse Survey, comparing LLM-driven displacement decisions to real reported outcomes.

`Example 7 <./examples/example_7.html>`_  demonstrates socio-technical regional recovery simulation, coupling physical infrastructure recovery with LLM-driven household displacement decisions.
