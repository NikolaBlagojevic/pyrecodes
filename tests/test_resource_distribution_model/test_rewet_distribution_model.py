...
from test_resource_distribution_model_inputs import FOLDER_NAME, RESOURCE_NAME_REWET, RESOURCE_PARAMETERS_REWET, INITIAL_R2D_DICT_REWET
...
class TestREWETDistributionModel:
    ...
    def test_update_component_met_demand(self, rewet_distribution_model):
        for component in rewet_distribution_model.components:
            component.update(0)
        rewet_distribution_model.met_demand_per_building = {"1": 0.7}
        rewet_distribution_model.update_buildings_met_demand(0)
